...
### **Prerequisites**
1. Install [Node.js](https://nodejs.org/) (16.x or above).
2. Set up an MSSQL database instance.
...
## **Database Setup**
1. Use the provided SQL schema to create the database tables in your MSSQL instance:
`
USE FlushEmailDB;
...
Here is the complete file in markdown syntax:
...
## **Usage**
1. Login or Register: Access the app by logging in with your credentials or registering a new account.
2. Manage Templates:
